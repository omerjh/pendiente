<?php
	...
	*/
	...
	$laRespuesta['lsServicio_Largo']= 'Preguntas Secretas';
	$laRespuesta['lsServicio_Corto']= 'Preguntas Secretas';
		...
		<section class="content">
			<div class="container-fluid">
				...
				<form method="POST" name="frmF" id="frmF" class="" action="../../controladores/corValidar.php">
					<input type="hidden" name="txtOperacion" id="txtOperacion" value="verificar_respuestas">
					...
					<div class="container-fluid bg-white">
						<div class="collapse navbar-collapse navbar-ex1-collapse show">
							<div class="form-group row justify-content-center">
								<label for="" class="col-form-label col-sm-4 col-md-4 col-lg-3 mt-1">Pregunta Secreta N° 1:</label>
								<div class="col-11 col-sm-5 mt-1">
									<label class="control-label">¿<?php print $_SESSION["sogem_u_pegunta_1"]; ?>?</label>
								</div>
								<div class="col-1">
								</div>
							</div>
							...
							<div class="form-group row justify-content-center">
								...
								<div class="col-11 col-sm-5 mt-1">
									<input type="password" class="form-control" name="txtRespuesta1" id="txtRespuesta1" onBlur="fsBorrar_Espacios(this,'texto_numero_simbolo')" onKeyPress="return fbSolo_Texto_Numeros_Simbolos(event,'txtRespuesta2')" value="" placeholder="Respuesta Secreta N° 1">
								</div>
								<div class="col-1">
							...
							<div class="form-group row justify-content-center">
								<label for="" class="col-form-label col-sm-4 col-md-4 col-lg-3 mt-1">Pregunta Secreta N° 2:</label>
								<div class="col-11 col-sm-5 mt-1">
									<label class="control-label">¿<?php print $_SESSION["sogem_u_pegunta_2"]; ?>?</label>
								</div>
								<div class="col-1">
								</div>
							</div>
							...
							<div class="form-group row justify-content-center">
								<div class="btn-group col-12 col-sm-2  margenes_botones">
									<button class="btn btn-primary" type="button" name="btnGuardar" id="btnGuardar" onClick="fpGuardar()"> Enviar </button>
								</div>
							</div>
						</div>
						<!-- Fin de Filtro -->
...
<script language="javascript" src="./js/jsRecuperar_Clave.js"></script>
