...
var gsUrl	= "../../controladores/corSistema.php";
window.onload = () => {
	fpListar();
};
...
function fpNuevo()
{
	document.querySelector('#h4Encabezado_Formulario').innerHTML='Registrar Sistema';
...
function fpBuscar(piCodigo)
{
	if(piCodigo >= 0)
	{
		...
		fpEnviar(loFormulario, laResultado => {
			...
			{
				document.querySelector('#h4Encabezado_Formulario').innerHTML='Actualizar Sistema';
				
				//asignacion de valores
				loF.txtOperacion.value	= 'modificar';
				loF.txtNombre.value		= laResultado.laDatos.txtNombre;
				loF.txtSiglas.value		= laResultado.laDatos.txtSiglas;
...
function fbValidar()
{
	...
	{
		fpMostrar_Mensaje("Disculpe, el nombre del sistema no puede estar en blanco",'a');
	}
	else if(loF.txtSiglas.value == "")
	{
		fpMostrar_Mensaje("Disculpe, la siglas del sistema no puede estar en blanco",'a');
	}
	else
	{
		lbBueno = true;
...
function fpListar(piPagina)
{
	...
	let laDatos = {
		txtOperacion		: 'listar',
		lsTitulos			: 'Código,Nombre,Siglas,Estado,Opciones',
...
/****************************************************************************************************
	...
	código del sistema y que al momento de buscar lo haga por coincidencia del nombre y no por código
****************************************************************************************************/
function fpVerificar_Sistema()
{
