...
var gsUrl	= "../../controladores/corDocumento.php";
window.onload = () => {
	fpListar();
};
...
function fpNuevo()
{
	document.querySelector('#h4Encabezado_Formulario').innerHTML='Registrar Documento';
	loF.txtOperacion.value = 'incluir';
	$("#divFormulario").modal("show");
	setTimeout(() => { loF.txtAbreviatura.focus(); }, 300);
}
...
function fbValidar()
{
	...
	else if(loF.txtAbreviatura.value == "")
	{
		fpMostrar_Mensaje("Disculpe, el nombre del documento no puede estar en blanco",'a');
	}
	else if(loF.txtNombre.value == "")
	{
		fpMostrar_Mensaje("Disculpe, el nombre del documento no puede estar en blanco",'a');
	}
	else if(loF.cmbTipo_Cliente.value == "")
	{
		fpMostrar_Mensaje("Disculpe, debe seleccionar el tipo de cliente",'a');
	}
...
function fpListar(piPagina)
{
	...
	let laDatos = {
		txtOperacion		: 'listar',
		lsTitulos			: 'Código,Abreviatura,Nombre,Tipo Cliente,Sistema,Estado,Opciones',
		lsPorcentajes		: '10%,10%,30%,20%,20%,10%',
		lsAlineacion		: 'right,left,left,left,left,left',
...
/****************************************************************************************************
	...
	código del documento y que al momento de buscar lo haga por coincidencia del nombre y no por código
****************************************************************************************************/
function fpVerificar_Documento()
{
