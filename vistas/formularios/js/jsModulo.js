...
var gsUrl	= "../../controladores/corModulo.php";
window.onload = () => {
	fpListar();
};
...
function fpNuevo()
{
	document.querySelector('#h4Encabezado_Formulario').innerHTML='Registrar Módulo';
...
function fpBuscar(piCodigo)
{
	if(piCodigo > 0)
	{
		...
		fpEnviar(loFormulario, laResultado => {
			...
			{
				document.querySelector('#h4Encabezado_Formulario').innerHTML='Actualizar Módulo';
...
function fpListar(piPagina)
{
	...
	let laDatos = {
		txtOperacion		: 'listar',
		lsTitulos			: 'Código,Nombre,Ícono,Ícono,Posición,Estado,Opciones',
		lsPorcentajes		: '10%,45%,15%,10%,10%,10%',
