	...
	<div class="content-wrapper">
		...
		<section class="content">
			<div class="container-fluid">
				...
				<form method="POST" name="frmFiltro" id="frmFiltro" class="" target="_blank" action="../reportes/xlsModulo.php">
						...
						<div class="collapse navbar-collapse navbar-ex1-collapse show">
							<div class="form-group row mt-1">
								...
								<div class="col-sm-3 mt-1">
									<input type="text" class="form-control" name="txtFiltro_Nombre" id="txtFiltro_Nombre" onBlur="fsBorrar_Espacios(this,'texto_numero_simbolo'); fpVerificar_Modulo()" onKeyPress="return fbSolo_Texto_Numeros_Simbolos(event,'cmbFiltro_Estado')" value="" placeholder="Módulo">
								</div>
			...
			<div class="modal-dialog modal-lg">
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<form method="POST" name="frmF" id="frmF" class="" action="../../controladores/corModulo.php">
							...
							<div class="form-group row">
								...
								<div class="col-11 col-sm-6">
									<input class="form-control" type="text" name="txtNombre" id="txtNombre" onBlur="fsBorrar_Espacios(this,'texto_numero_simbolo')" onKeyPress="return fbSolo_Texto_Numeros_Simbolos(event,'txtIcono')" value="" placeholder="Nombre" maxlength="30">
								</div>
							...
							<div class="form-group row">
								...
								<div class="col-11 col-sm-6">
									<input class="form-control" type="number" name="txtPosicion" id="txtPosicion" onBlur="fsBorrar_Espacios(this,'numero')" onKeyPress="return fbSolo_Numeros(event,this,'btnGuardar')" value="" placeholder="Posición" maxlength="3">
								</div>
								<div class="col-1 col-sm-1">
									<span class="fa fa-asterisk text-danger"></span> 
								</div>
...
<script language="javascript" src="./js/jsModulo.js"></script>
