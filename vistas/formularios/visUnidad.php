	...
	<div class="content-wrapper">
		...
		<section class="content">
			<div class="container-fluid">
				...
				<form method="POST" name="frmFiltro" id="frmFiltro" class="" target="_blank" action="../reportes/xlsUnidad.php">
			...
			<div class="modal-dialog modal-lg">
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<form method="POST" name="frmF" id="frmF" class="" action="../../controladores/corUnidad.php">
...
<script language="javascript" src="./js/jsUnidad.js"></script>
