<?php
	...
	*/
	...
	// print "<pre>";
	// print_r($_SESSION["sogem_u_permisos"]);
	// print "</pre>";
	...
	<div class="content-wrapper">
		...
		<section class="content">
			<div class="container-fluid">
				...
				<form method="POST" name="frmFiltro" id="frmFiltro" class="" target="_blank" action="../reportes/xlsRol.php">
						...
						<div class="collapse navbar-collapse navbar-ex1-collapse show">
							<div class="form-group row mt-1">
								...
								<div class="col-sm-3 mt-1">
									<input type="text" class="form-control" name="txtFiltro_Nombre" id="txtFiltro_Nombre" onBlur="fsBorrar_Espacios(this,'texto_numero_simbolo'); fpVerificar_Rol()" onKeyPress="return fbSolo_Texto_Numeros_Simbolos(event,'cmbFiltro_Estado')" value="" placeholder="Rol">
								</div>
			...
			<div class="modal-dialog modal-lg">
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<form method="POST" name="frmF" id="frmF" class="" action="../../controladores/corRol.php">
							...
							<div class="row" id="divServicio"></div>
...
<script language="javascript" src="./js/jsRol.js"></script>
