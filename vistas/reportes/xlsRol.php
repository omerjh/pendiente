<?php
	...
	*/
	...
	if($loRol->fbListar_Excel($_POST) === true)
	{
		$laMatriz = $loRol->faGetVariables();
	}
	else
	{
	...
	$lsTitulo_Hoja = 'Listado de Roles';
	...
	header('Content-Disposition: attachment;filename="Listado-de-rol.xls"');
